...
df3 = pd.read_csv('Data/stop_times.txt', on_bad_lines='skip', low_memory=False)
df4 = pd.read_csv('Data/Stops.txt', on_bad_lines='skip', low_memory=False)
df1 = pd.read_csv('Data/Vehicle_Update.csv', on_bad_lines='skip', low_memory=False)
df2 = pd.read_csv('Data/Trip_Update.csv', on_bad_lines='skip', low_memory=False)
